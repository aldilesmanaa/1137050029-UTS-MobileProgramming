package com.example.budakleutik02.mobpro_uts_aldilesmanamuhammadrizal_1137050029;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Pil = new String[] {"Pink Cake", "Strawberry Chocolate", "White Cake", "Coffe Cake"};
        Gbr = new String[] {
                Integer.toString(R.drawable.kue001),
                Integer.toString(R.drawable.kue002),
                Integer.toString(R.drawable.kue003),
                Integer.toString(R.drawable.kue004),};
